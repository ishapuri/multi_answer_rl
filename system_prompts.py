...
GEN_PROMPT_MEDICAL = (
    "A conversation between User and Assistant. The user presents a medical case, and the Assistant provides a diagnosis. You are a medical expert analyzing patient information including patiet demographics, symptoms, and medical antecedents.The assistant "
...
MULTI_ANSWER_PROMPT_TEMPLATE_SHORT_MEDICAL = (
    ...
    "You are a medical expert analyzing patient information including patiet demographics, symptoms, and medical antecedents.\n"
...
def get_sys_prompt(sys_prompt_name):
    if sys_prompt_name == "gen":
        return GEN_PROMPT
    elif sys_prompt_name == "gen_medical":
